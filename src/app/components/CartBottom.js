...
const CartBottom = () => {
  ...
  return (
      ...
      {/* checkout modal */}
      {modal && (
      <Modal className='bg-white w-full h-full lg:max-w-[900px] lg:max-h-[600px] lg:rounded-[30px] lg:fixed
      lg:top-[50%] lg:left-[50%] lg:translate-x-[-50%] lg:translate-y-[-50%] outline-none'
        isOpen={modal} style={modalStyles} onRequestClose={closeModal} contentLabel='Checkout Modal'>
          {/* close modal icon */}
