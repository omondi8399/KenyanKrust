    ...
    <div>
      {successMsg ? ( 
        <div className='flex flex-col justify-center items-center h-[100vh] lg:h-[600px] px-6'>
          ...
          <Image src={'/public/success-1.gif'} width={150} height={150} alt=''/>
          <div>
        ...
        <div className='h-[86vh] lg:h-[47.5vh] flex flex-col lg:flex-row lg:gap-x-4'>
          ...
          {/* box 2 */}
          <div className='flex-1 h-full lg:max-w-[40%] flex flex-col justify-between pt-3 px-8 
          lg:p-0'>
            ...
            <button onClick={() => setSuccessMsg(true)}
              className='btn btn gradient w-full'>Place order</button>
          </div>
        </div>
          </div>
        )}
